...
## Jupyter Notebook (Cell-by-Cell Rmd Mirror)

The project now includes:

- `analysis.ipynb`

It mirrors the original `Final Project.Rmd` flow cell-by-cell in Python (data load, transformations, regressions, correlations, clustering, and cluster-level follow-up analysis).
